            ...
            for i in range(0,len(data)):
                if xulie==data[i][0]:
                    ...
                    for i in m:
                        c=c+i+'\n'+"\n"
                        d=c
                    image_path = "D:/Python/Demo/PycharmProjects-2/picture/" + str(xulie) + ".png"
    ...
    def changeValue(self, value):
        ...
        with open(filename, 'r', encoding='utf-8') as f:
            ...
            for row in reader:  # 一行为一个列表
                ...
                d4.append(row[3])
                d5.append(row[4])
                image_path = "D:/Python/Demo/PycharmProjects-2/picture/" + str(k) + ".png"
        ...
        if pos == 0:
            ...
            self.label_2.setPixmap(QPixmap('D:/Python/Demo/PycharmProjects-2/picture/29.png'))
        else:
            self.label_2.setPixmap(QPixmap('D:/Python/Demo/PycharmProjects-2/picture/4.png'))
    def appFile(self):
        data=[]
        xulie = self.etid.text()
        filename=self.openet.text()
